...
public class GamePanel extends JPanel implements ActionListener, KeyListener
{
  ...
  /*
   * Boolean variables for game structure: hasLost:chnages to true when ball
   * moves below paddle. hasWon: changes to true when player clears all levels.
  ...
  {
    // Checks loss condition and stops timer if true, and resets the paddle
    // width.
    if (hasLost || hasWon)
    {
